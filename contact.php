...
<body>
            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <div class="d-inline-flex align-items-center">
                        ...
                        <a class="btn btn-outline-primary disabled" href="contact.php">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="d-flex flex-column justify-content-center bg-primary h-100 p-5">
                        ...
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Email Us</h4>
                                <p class="m-0 text-white">ubaidahmed1282@gmail.com</p>
                            </div>
                        </div>
                        <div class="d-inline-flex border border-secondary p-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Call Us</h4>
                                <p class="m-0 text-white">+92 3120003019</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 mb-5 my-lg-5 py-5 pl-lg-5">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control p-4" id="subject" name="subj" placeholder="Subject" required="required" data-validation-required-message="Please enter a subject" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <textarea class="form-control p-4" rows="6" id="message" name="mass" placeholder="Message" required="required" data-validation-required-message="Please enter your message"></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div>
                                <button class="btn btn-primary py-3 px-5" type="submit" name="insart" id="sendMessageButton">Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <?php
                    if (isset($_POST['insart'])) {
                        ...
                        $sql = "INSERT INTO user(name,email,subject,massege) VALUES ('$name','$email','$sub','$mass')";
                        $result = mysqli_query($con, $sql);
                        
                        if ($result) {
                            echo "<script> alert(' massege send successfully');
                </script>";
                        }
                    }
