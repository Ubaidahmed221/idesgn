            ...
            <div class="row">
                <div class="col-12 text-center mb-2">
                    <ul class="list-inline mb-4" id="portfolio-flters">
                        ...
                        <li class="btn btn-outline-primary m-1" data-filter=".Running">Running</li>
              ...
              <div class="row mx-1 portfolio-container">
                ...
                while($fetch = mysqli_fetch_assoc($resul)){ 
                    ?>
                    <div class='col-lg-4 col-md-6 col-sm-12 p-0 portfolio-item <?php echo $fetch['procatename']?>'>
                 ...
                 <img class='img-fluid' src="dashboard/pimages/<?php echo $fetch['pimg'] ?>" alt="">
                        ...
                        <div class='portfolio-text bg-secondary d-flex flex-column align-items-center justify-content-center'>
                            ...
                            <p class='text-white mb-4 text-center'><?php echo $fetch['pshortdes'] ?></p>
